...
<table cellpadding="2" cellspacing="0" border="0" width="100%">
    ...
    <tr valign="top" bgcolor="#eeeeee">
        ...
        <td width="100%"><input type="text" size="10" name="sale_price" value="<?php echo $sale_price; ?>">(In Peso)</td>
    </tr>
    <tr valign="top" bgcolor="#eeeeee">
...
?>
        ...
        <tr valign="top" bgcolor="#eeeeee">
            ...
            <td><b><?php echo "P " . number_format($down_payment, "2", ".", ","); ?></b></td>
        </tr>
        <tr valign="top" bgcolor="#eeeeee">
            <td align="right">Amount Financed:</td>
            <td><b><?php echo "P " . number_format($financing_price, "2", ".", ","); ?></b></td>
        </tr>
        <tr valign="top" bgcolor="#cccccc">
            <td align="right">Monthly Payment:</td>
            <td><b><?php echo "P " . number_format($monthly_payment, "2", ".", ","); ?></b><br><font>(Principal &amp; Interest ONLY)</font></td>
        </tr>
        <?php
            if ($down_percent < 20) {
        ...
        ?>
                ...
                <tr valign="top" bgcolor="#FFFF99">
                    <td align="right">Monthly Payment:</td>
                    <td><b><?php echo "P " . number_format(($monthly_payment + $pmi_per_month), "2", ".", ","); ?></b><br><font>
        ...
        <tr valign="top" bgcolor="#9999FF">
            ...
            <td><b><?php echo "P " . number_format(($monthly_payment + $pmi_per_month + $residential_monthly_tax), "2", ".", ","); ?></b><br><font>
...
<?php
        ...
        print("<br><br><a name=\"amortization\"></a>Amortization For Monthly Payment: <b>P " . number_format($monthly_payment, "2", ".", ",") . "</b> over " . $year_term . " years<br>\n");
        ...
        while ($current_month <= $month_term) {        
            ...
            print("\t\t<td align=\"right\">P " . number_format($interest_paid, "2", ".", ",") . "</td>\n");
            print("\t\t<td align=\"right\">P " . number_format($principal_paid, "2", ".", ",") . "</td>\n");
            print("\t\t<td align=\"right\">P " . number_format($remaining_balance, "2", ".", ",") . "</td>\n");
            print("\t</tr>\n");
            ...
            if ($show_legend) {
                ...
                print("\t\t<td>&nbsp;</td>\n");
                print("\t\t<td colspan=\"3\">\n");
                print("\t\t\tYou will spend P " . number_format($total_spent_this_year, "2", ".", ",") . " on your house in year " . $current_year . "<br>\n");
                print("\t\t\tP " . number_format($this_year_interest_paid, "2", ".", ",") . " will go towards INTEREST<br>\n");
                print("\t\t\tP " . number_format($this_year_principal_paid, "2", ".", ",") . " will go towards PRINCIPAL<br>\n");
                print("\t\t</td>\n");
                print("\t</tr>\n");
