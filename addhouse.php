...
?>
 ...
 <div class="warper container-fluid">
  ...
  <div class="page-header"><h1>Add House<small>JLEEM Realty</small></h1></div>
   ...
   <table width="472" height="210" border="0" align="center">
    <tr>
	
      <td width= width="146" height="32">Name of Subdivision</td>
      <td width="327"><select name="subname" style="width:220px" class="input">
