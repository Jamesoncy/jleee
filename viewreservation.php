...
<body>
<div class="main">
<img src="html/images/logo.png" alt="logo" width="100"  height="100" align="middle" style="margin-left: 0px;"/>
      <div style="margin-top: -107px; margin-left: 103px; font-weight:bold; font-size:30px; width:500px;"> JLEEM Realty Corporation:
	   </div>
	<div style="margin-top: -1px; margin-left: 103px;width:400px; font-size:11px; text-align:center">1B233, L25, St. Anne Deca Homes, Loma de Gato, Marilao Bulacan<br />
...
<br />
	...
	If ($numberOfRows == 0) 
		...
		$i=0;
			...
			$amount = MYSQL_RESULT($result,$i,"amount_finance");
	...
	<td width="344">&nbsp;<font color="#FF0000"> Php</font>&nbsp;<?php echo number_format($downpayment,2) ; ?> </td>
	</tr>
	<tr>
	<td width="352" style="font-weight:bold">Monthly Amortization:</td>
	...
	<td width="344">&nbsp;<font color="#FF0000"> Php</font>&nbsp;<?php echo number_format($amount,2) ; ?> </td>
	</tr>
	</table><br /><br />
	<div align="center">
