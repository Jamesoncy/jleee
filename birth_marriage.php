...
Upload Copy/s
Marriage Contract ( if Married) <br /><br/>

	<form  action="savebirth_marriage.php"method="post" enctype="multipart/form-data" id="signupForm">
...
<br />
<div align="center">
  <h3>Upload First Page of Marriage Contract</h3>
</div><br />
File Name:
