				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="modelhouse.php">Model Houses</a></li>
						...
						<div class="row">
							<div class="col-md-5">
								<div class="project-images">
									<?php
										echo file_get_contents("Erica.txt");
									?>
									<div class="thumbs">
										<a href="#"><img src="html/dummy/small-thumb-1.jpg" alt="#"></a>
										<a href="#"><img src="html/dummy/small-thumb-2.jpg" alt="#"></a>
										<a href="#"><img src="html/dummy/small-thumb-3.jpg" alt="#"></a>
									</div>
								</div>
							</div>
							<div class="col-md-7">
								<div class="project-detail">
									<h2 class="project-title">eiusmod tempor incididunt lorem labore et dolore</h2>
