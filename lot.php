...
<title>JLEEM - List of Lots</title>
...
?>
 ...
 <div class="warper container-fluid">
  ...
  <div class="page-header"><h1>Lots <small>JLEEM Realty</small></h1></div>
...
?>
    <tr>
      ...
      <td  ><?php echo $lotarea ?></td>
      <td  ><font color="#FF0000"> Php</font> <?php echo  number_format($price ,2);?></td>
      <td  ><font color="#FF0000"> Php</font> <?php echo number_format($tcp,2); ?></td>
      <td ><?php echo $status ?></td>
      <td ><a href="editlot.php?lotid= <?php echo $lotid; ?>"><img src="img/edit.png" width="25" height="25" border="0" /></a></h6></td>
      <td  ><a href="deletelot.php?lotid= <?php echo $lotid; ?>"><img src="img/cancel.png"onclick="return confirm('Are you sure you want to delete a lot no. <?php echo $lotid ?>');" width="25" height="25" border="0" /></a></td>
    </tr>
    <?php 	
$i++;		
	}
