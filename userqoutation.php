...
<div class="content"><br /> 
	...
	Price/sq.m: &nbsp; <?php echo $price; ?><br />
	Downpayment: &nbsp; <?php echo $downpayment; ?><br />
	5 yrs. to Pay: &nbsp; Php &nbsp;<?php echo $five; ?><br />
	7 yrs. to Pay: &nbsp; Php &nbsp;<?php echo $seven; ?><br />
	10 yrs. to Pay:&nbsp;Php &nbsp;<?php echo $ten; ?><br />
	</div>
	<br /><br />
	<br />
*Note:<br />
