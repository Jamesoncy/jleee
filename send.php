...
$sql="SELECT * FROM reserve WHERE email= reserveid ";
...
<div align="center">
Receiver:<br /> <br />
<input type="text" name="email" class="input4" style="text-align:center"  value="<?php echo $records['email']; ?>"/>
<br />
<br />
Subject:<br /><br />
...
Our valued customer,
We would like to remind you of your amortization balance payment.
