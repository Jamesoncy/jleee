...
?>
                          <tr>
                            ...
                            <td align="center"><a href="editsubdivision.php?subid= <?php echo $subid; ?>"><i class="fa fa-pencil-square"></i> </a></td>
                            <td align="center"><a  href="deletesub.php?subid= <?php echo $subid; ?>"><i class="fa fa-minus-square" onclick="return confirm('Are you sure you want to delete subdivision  <?php echo $subid; ?>');" /></i></a></td>
                          </tr>
