...
?>
  ...
  <div class="page-header"><h1>Reply</h1></div>
 		<div class="panel panel-default">

                        <div class="panel-body table-responsive">

<h5> Sender:</h5> <input type="email" class="form-control" id="exampleInputEmail1" value="<?php echo $email; ?>" style="margin-left:3px;"  class="input9"/><br />

 

   <div class="warper container-fluid">
        	
            <div class="page-header"><h1>Message </h1></div>
            
    
            <textarea class="wysihtml form-control" placeholder="Enter text ..." style="height: 200px">
