...
?>
 ...
 <div class="warper container-fluid">
  ...
  <div class="page-header"><h1>All Company Events <small>JLEEM Realty</small></h1></div>
...
If ($rows == 0) 
	...
	while ($i<$rows)
		{		
			...
			$activity = MYSQL_RESULT($result,$i,"activity_name");
			$id = MYSQL_RESULT($result,$i,"activity_id");
		
?>
                            <tr>
                              <td height="38" align="center"><a href="uploadpic.php?activityid=<?php echo $id; ?>"><h1><?php echo $activity ?></h1></a></td>
                              <td align="center"><a href="uploadpic.php?activityid=<?php echo $id; ?>">Upload Picture</a></td>
                              <td align="center"><a href="deleteact.php?activityid=<?php echo $id ?>">Delete</a></td>
                            </tr>
                            <?php 	
$i++;		
	}
