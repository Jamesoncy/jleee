...
<title>Create Company Events</title>
 ...
 <nav class="navigation">
            	<ul class="list-unstyled">
                   ...
                   <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="events.php"><i class="fa fa-building"></i> <span class="nav-label">Company Events</span></a>
                    	<ul class="list-unstyled">
...
<br /><h1><center>Upload Another Picture for <?php echo $dirName; ?></h1></center>
<br />
	  <?php
		include("include/dbconnection.php");
		$id=$_POST['dirName'];
...
<center>
<input type="submit" class="btn" name="save"  id="image" value="Upload Picture" /></center>
</form>
</div>
</div>
<!-- JQuery v1.9.1 -->
