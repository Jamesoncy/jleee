	...
	<body>
		<div id="site-content">
			...
			<main class="main-content">
				...
				<div class="page">
					<div class="container">
						<a href="project.html" class="button-back"><img src="html/images/arrow-back.png" alt="" class="icon">Back to the projects</a>

						<div class="row">
							<div class="col-md-5">
								<div class="project-images">
									<?php
										echo file_get_contents("amara.txt");
									?>
								</div>
							</div>
							...
							<div class="col-md-7">
								<div class="project-detail">
									<h2 class="project-title">AMARA</h2>
